...
export async function runMigration() {
  ...
  try {
    ...
    const queries = [
      ...
      {
        name: "products.shipping_cost_per_pcs",
        sql: "ALTER TABLE products ADD COLUMN shipping_cost_per_pcs INT DEFAULT 0"
      },
      {
        name: "products.other_cost_per_pcs",
        sql: "ALTER TABLE products ADD COLUMN other_cost_per_pcs INT DEFAULT 0"
      }
    ];
