    ...
    >
      <div className="flex flex-col items-center gap-6 z-10 relative">
        <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 overflow-hidden px-4">
          ...
          <div className="animate-[splash-bara_1.2s_cubic-bezier(0.16,1,0.3,1)_forwards] opacity-0 -translate-x-[150%] rotate-[-15deg] shrink-0">
          ...
          <div className="animate-[splash-text_1.2s_cubic-bezier(0.16,1,0.3,1)_0.2s_forwards] opacity-0 translate-x-[150%] flex flex-col justify-center items-center sm:items-start text-center sm:text-left">
